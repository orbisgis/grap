...
/*
 * This class has been found on website :
 ...
 * <code>true</code> as argument to identify animated GIFs ({@link #getNumberOfImages()}
 ...
 * </li>
 * <li><strong>2006-11-13</strong> Removed check that made ImageInfo report
 * JPEG APPx markers smaller than 14 bytes as files in unknown format. Such
 * JPEGs seem to be generated by Google's Picasa application. First reported
 * with fix by Karl von Randow. Released as 1.9.</li>
 * </ul>
 * 
...
public class ImageInfo {
	...
	private static boolean equals(byte[] a1, int offs1, byte[] a2, int offs2,
			int num) {
		while (num-- > 0) {
	 ...
	 *             if index is smaller than 0 or larger than or equal to the
	 ...
	 * {@link #setCollectComments(boolean)} was called with <code>true</code>
	 * as argument, returns the number of comments retrieved from the input
	 * image stream / file. Any number &gt;= 0 and smaller than this number of
	 ...
	 * that {@link #check()} was successful. Returns <code>-1</code> on
	 * failure.
	 * 
	 ...
	 * Default is <code>false</code>. If enabled, comments will be added to
	 * an internal list.
	 * 
	 * @param newValue
	 ...
	 * file formats require running over the entire file to find out the number
	 * of images, a rather time-consuming task. Not all file formats support
	 * more than one image. If this method is called with <code>true</code> as
