...
public class D8OpDirection extends D8Operation implements Operation {
	...
	public GeoRaster sequential(final GeoRaster grDEM)
			throws OperationException, GeoreferencingException {
		try {
			...
			final short[] slopesDirections = new short[nrows * ncols];
			int i = 0;
			...
			final GeoRaster grSlopesDirections = GeoRasterFactory
					.createGeoRaster(slopesDirections, ncols, nrows,
							rasterMetadata);
			grSlopesDirections
					.setNodataValue(PixelUtilities.noDataValueForDirection);
