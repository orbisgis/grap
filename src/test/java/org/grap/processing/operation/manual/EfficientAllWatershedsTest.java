...
import org.grap.processing.operation.EfficientAllWatersheds;
import org.grap.processing.operation.SlopesDirections;

public class EfficientAllWatershedsTest {
	public static void main(String[] args) throws Exception {
		...
		final Operation allWatersheds = new EfficientAllWatersheds();
