...
public class Rasterizingtest extends GrapTest {
	
	
	//	TODO Multiple Rois test. An example is available in RasterizationManualTest.
	...
	public void testRasterizingFILL() throws Exception {
		...
		final GeoRaster gResult = geoRasterSrc.doOperation(rasterizing);
		 ...
		 //Ckeck if pixel values are correct. 
